...
def main() -> None:
    ...
    parser.add_argument("--reference", default="data/raw/train.csv", help="Reference CSV path")
    parser.add_argument("--current", default="data/raw/test.csv", help="Current CSV path to compare against reference")
